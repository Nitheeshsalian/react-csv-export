...
var _sheetjsStyle = require('sheetjs-style');

var _sheetjsStyle2 = _interopRequireDefault(_sheetjsStyle);
...
var excelSheetFromDataSet = function excelSheetFromDataSet(dataSet) {
    ...
    dataSet.forEach(function (dataSetItem) {
        ...
        if (columns.length >= 0) {
            columns.forEach(function (col, index) {
                var cellRef = _sheetjsStyle2.default.utils.encode_cell({ c: xSteps + index, r: rowCount });
        ...
        for (var R = 0; R != data.length; ++R, rowCount++) {
            for (var C = 0; C != data[R].length; ++C) {
                var cellRef = _sheetjsStyle2.default.utils.encode_cell({ c: C + xSteps, r: rowCount });
    ...
    if (range.s.c < 10000000) {
        ws['!ref'] = _sheetjsStyle2.default.utils.encode_range(range);
    }
...
function getCell(v, cellRef, ws) {
    ...
    if (typeof v === 'number') {
        ...
        cell.t = 'n';
        cell.z = _sheetjsStyle2.default.SSF._table[14];
...
var excelSheetFromAoA = function excelSheetFromAoA(data) {
    ...
    for (var R = 0; R != data.length; ++R) {
        for (var C = 0; C != data[R].length; ++C) {
            ...
            var cellRef = _sheetjsStyle2.default.utils.encode_cell({ c: C, r: R });
